var CONFIG_DEFAULTS={
  DEFAULT_PROSPECT_TARGET:50,MAX_CONTACT_ATTEMPTS:5,FIRST_CONTACT_SLA_HOURS:24,CALL_RETRY_HOURS:24,CONTACT_ATTEMPT_MIN_HOURS:4,CALLBACK_GRACE_MINUTES:15,
