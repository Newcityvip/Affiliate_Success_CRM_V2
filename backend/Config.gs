var CONFIG_DEFAULTS={
  DEFAULT_PROSPECT_TARGET:50,MAX_CONTACT_ATTEMPTS:5,FIRST_CONTACT_SLA_HOURS:24,CALL_RETRY_HOURS:24,ATTEMPT_TWO_WAIT_HOURS:72,ATTEMPT_THREE_WAIT_HOURS:120,CALLBACK_GRACE_MINUTES:15,
