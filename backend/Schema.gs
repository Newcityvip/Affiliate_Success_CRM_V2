...
var SCHEMA = {
  ...
  Monthly_Performance: ['Performance_ID','Affiliate_ID','Brand_ID','Period','Year','Month','FTD','Active_Players','Registrations','Deposits_Count','Deposit_Amount','Turnover','Revenue_NGR','Commission','Conversion_Rate','Previous_FTD','FTD_Change_Percent','Previous_NGR','NGR_Change_Percent','Imported_At','Import_Batch_ID','Created_By','Withdrawal_Amount'],
