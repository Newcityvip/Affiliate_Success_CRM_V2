...
export function AppShell({children}:{children:React.ReactNode}) {
  ...
  async function logout(){try{await api.logout()}finally{clearReadCache();localStorage.removeItem('crm_session_token');localStorage.removeItem('crm_user');router.replace('/')}}
